 ...
 */
export class FilterHelperExtension extends HandlebarsExtension {
  public static readonly engineId = 'handlebars';

  public register(): void {
    this.hbs.registerHelper('filter', function(this: any, array: any[], property: string, value: any, options: any) {
  ...
  public unregister(): void {
    this.hbs.unregisterHelper('filter');
  }
}
